...
username = "slattery.75@osu.edu" #input("Enter your username: (slattery.75@osu.edu)") or "slattery.75@osu.edu"
password = "jacksfriendswatchmovies" #input("Enter your password: (jacksfriendswatchmovies)") or "jacksfriendswatchmovies"
serverip = "CRUCIAL_CONTROL_WARD" #input("Enter your server ip: (CRUCIAL_CONTROL_WARD)") or "CRUCIAL_CONTROL_WARD"
...
cursor.execute("SELECT added_at FROM metadata_items WHERE title = \""+chosenMovieTitle+"\" and library_section_id = "+chosenLibraryKey)
print(chosenMovieTitle+"\'s current added date is: "+ cursor.fetchall()[0])
#
